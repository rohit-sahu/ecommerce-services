...
public class CORSFilterConfig extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        ...
        response.setHeader("Access-Control-Allow-Headers", "authorization,X-Requested-With,Access-Control-Request-Headers,Origin,Accept,content-type,app-subject, xsrf-token,ORDER-SERVICE");
